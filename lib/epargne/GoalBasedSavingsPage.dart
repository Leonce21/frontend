import 'package:epargne_plus/epargne/GoaldoSaving.dart';
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        if (data is List<dynamic>) {
          setState(() {
            transactions = data.where((t) =>t['savingType']?.toString().toLowerCase() == 'goal')
                .toList();
          });
        } else {
          setState(() {
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () => Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => GoaldoSaving(

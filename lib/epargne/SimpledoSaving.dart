...
class SimpledoSaving extends StatefulWidget {
  final String accountId;
  final String internalId;

  const SimpledoSaving({super.key, required this.accountId, required this.internalId});

  @override
  _SimpledoSavingState createState() => _SimpledoSavingState();
}

class _SimpledoSavingState extends State<SimpledoSaving> {

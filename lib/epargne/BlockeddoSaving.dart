import 'package:epargne_plus/epargne/BlockedSavingsPage.dart';
import 'package:flutter/material.dart';
import '../components/custom_colors.dart';
import '../service/api_service.dart';

class BlockeddoSaving extends StatefulWidget {
  final String accountId;
  final String internalId;

  const BlockeddoSaving({super.key, required this.accountId, required this.internalId});

  @override
  _BlockeddoSavingState createState() => _BlockeddoSavingState();
}

class _BlockeddoSavingState extends State<BlockeddoSaving> {
